            ...
            <tbody>
              <tr>
                <td style="border-bottom:1px solid #f6f6f6;"><h1 style="font-size:14px; font-family:arial; margin:0px; font-weight:bold;">Dear Sir/Madam/Customer,</h1>
                  <p style="margin-top:0px; color:#bbbbbb;">Fundraising request {{ $email_data->status }}</p></td>
              </tr>
              <tr>
                <td style="padding:10px 0 30px 0;"><p>  Fundraising request {{ $email_data->status }}.</p>
                  <center>
                  </center>
