            ...
            <tbody>
              <tr>
                <td style="border-bottom:1px solid #f6f6f6;"><h1 style="font-size:14px; font-family:arial; margin:0px; font-weight:bold;">Dear Sir/Madam/Customer,</h1>
                  <p style="margin-top:0px; color:#bbbbbb;">Submission Created.</p></td>
              </tr>
              <tr>
                <td style="padding:10px 0 30px 0;"><p> {{ $email_data->submission_name }}, <br> {{ config('app.app_email_title')}} - Submission Created:</p>
                  <center>
                  </center>
