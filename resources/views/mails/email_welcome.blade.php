        ...
        <div style="padding: 40px; background: #fff;">
          <table border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
            <tbody>
              ...
              <tr>
                <td style="padding:10px 0 30px 0;"><p> Welcome to The Byline Project! <br>
                	You may begin a new story submission by logging on to <u><a href="https://{{ $_SERVER['SERVER_NAME'] }}/">The Byline Project</a></u>.
                </p>
                  <center>
