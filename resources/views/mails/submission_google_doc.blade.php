            ...
            <tbody>
              ...
              <tr>
                <td style="padding:10px 0 30px 0;">
                  <p>A new Google Doc has been created for your commissioned story. Please click the link below to access the Google Doc.<br>
                  	<a href="https://docs.google.com/document/d/{{ $email_data->doc_id }}">https://docs.google.com/document/d/{{ $email_data->doc_id }}</a>
                     <br>
                     <center>
                        <a href="https://docs.google.com/document/d/{{ $email_data->doc_id }}" style="display: inline-block; padding: 11px 30px; margin: 20px 0px 30px; font-size: 15px; color: #fff; background: #00c0c8; border-radius: 60px; text-decoration:none;">View Google Document</a>
                     </center>
                  </p>
