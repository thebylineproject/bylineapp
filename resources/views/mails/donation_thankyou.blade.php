            ...
            <tbody>
              <tr>
                <td style="border-bottom:1px solid #f6f6f6;"><h1 style="font-size:14px; font-family:arial; margin:0px; font-weight:bold;">Hello {{ $email_data->user_name }},</h1>
                  ...
                  <p style="margin-top:0px; color:#bbbbbb;"><strong>Tip Amount:</strong> ${{ $email_data->donation_amount }}</p></td>
              </tr>
              <tr>
                <td style="padding:10px 0 30px 0;"><p>Thank you for supporting <u><a href="https://{{ $_SERVER['SERVER_NAME'] }}/">The Byline Project</a></u>. {{ $email_data->reporter_name}} has received your tip!<br>
